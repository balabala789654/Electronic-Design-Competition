...
/* GPIO defines for PWM LED_IR_MOD (PA.3 using TIMG2_C0 function) */
#define GPIO_LED_IRMOD_PORT                                             (GPIOA)
#define GPIO_LED_IRMOD_PIN                                      (DL_GPIO_PIN_3)
#define GPIO_LED_IRMOD_IOMUX                                     (IOMUX_PINCM4)
#define GPIO_LED_IRMOD_IOMUX_FUNCTION              (IOMUX_PINCM4_PF_TIMG2_CCP0)

/* GPIO defines for PWM LED_BL_MOD (PA.4 using TIMG2_C1 function) */
#define GPIO_LED_BLMOD_PORT                                             (GPIOA)
#define GPIO_LED_BLMOD_PIN                                      (DL_GPIO_PIN_4)
#define GPIO_LED_BLMOD_IOMUX                                     (IOMUX_PINCM5)
#define GPIO_LED_BLMOD_IOMUX_FUNCTION              (IOMUX_PINCM5_PF_TIMG2_CCP1)

/* GPIO defines for PWM LED_DEMOD (PA.12 using TIMG0_C0 function) */
#define GPIO_LED_DEMOD_PORT                                             (GPIOA)
#define GPIO_LED_DEMOD_PIN                                     (DL_GPIO_PIN_12)
#define GPIO_LED_DEMOD_IOMUX                                    (IOMUX_PINCM13)
#define GPIO_LED_DEMOD_IOMUX_FUNCTION             (IOMUX_PINCM13_PF_TIMG0_CCP0)

/* GPIO defines for PWM LED_DEMODB (PA.13 using TIMG0_C1 function) */
#define GPIO_LED_DEMODB_PORT                                            (GPIOA)
#define GPIO_LED_DEMODB_PIN                                    (DL_GPIO_PIN_13)
#define GPIO_LED_DEMODB_IOMUX                                   (IOMUX_PINCM14)
#define GPIO_LED_DEMODB_IOMUX_FUNCTION            (IOMUX_PINCM14_PF_TIMG0_CCP1)

/* GPIO defines for PWM INT_RST (PA.7 using TIMG1_C0 function) */
#define GPIO_INT_RST_PORT                                               (GPIOA)
#define GPIO_INT_RST_PIN                                        (DL_GPIO_PIN_7)
#define GPIO_INT_RST_IOMUX                                       (IOMUX_PINCM8)
#define GPIO_INT_RST_IOMUX_FUNCTION                (IOMUX_PINCM8_PF_TIMG1_CCP0)

/* GPIO (DEBUG) defines for PWM ADC_TRIGGER (PA.27 using TIMG1_C1 function) */
#define GPIO_ADC_TRIGGER_PORT                                           (GPIOA)
#define GPIO_ADC_TRIGGER_PIN                                   (DL_GPIO_PIN_27)
#define GPIO_ADC_TRIGGER_IOMUX                                  (IOMUX_PINCM28)
#define GPIO_ADC_TRIGGER_IOMUX_FUNCTION           (IOMUX_PINCM28_PF_TIMG1_CCP1)

/* GPIO defines for OPA0_OUT (Unconnected for digital pin function) */
#define GPIO_OPA0_OUT_PORT                                              (GPIOA)
#define GPIO_OPA0_OUT_PIN                                      (DL_GPIO_PIN_22)
#define GPIO_OPA0_OUT_IOMUX                                     (IOMUX_PINCM23)
#define GPIO_OPA0_OUT_IOMUX_FUNCTION             (IOMUX_PINCM23_PF_UNCONNECTED)

/* GPIO defines for OPA0_IN0- (Unconnected for digital pin function) */
#define GPIO_OPA0_IN0M_PORT                                             (GPIOA)
#define GPIO_OPA0_IN0M_PIN                                     (DL_GPIO_PIN_24)
#define GPIO_OPA0_IN0M_IOMUX                                    (IOMUX_PINCM25)
#define GPIO_OPA0_IN0M_IOMUX_FUNCTION            (IOMUX_PINCM25_PF_UNCONNECTED)

/* GPIO defines for OPA1_OUT (Unconnected for digital pin function) */
#define GPIO_OPA1_OUT_PORT                                              (GPIOA)
#define GPIO_OPA1_OUT_PIN                                      (DL_GPIO_PIN_16)
#define GPIO_OPA1_OUT_IOMUX                                     (IOMUX_PINCM17)
#define GPIO_OPA1_OUT_IOMUX_FUNCTION             (IOMUX_PINCM17_PF_UNCONNECTED)

/* GPIO defines for OPA1_IN0- (Unconnected for digital pin function) */
#define GPIO_OPA1_IN0M_PORT                                             (GPIOA)
#define GPIO_OPA1_IN0M_PIN                                     (DL_GPIO_PIN_17)
#define GPIO_OPA1_IN0M_IOMUX                                    (IOMUX_PINCM18)
#define GPIO_OPA1_IN0M_IOMUX_FUNCTION            (IOMUX_PINCM18_PF_UNCONNECTED)

/* GPIO defines for OPA1_IN0+ (Unconnected for digital pin function) */
#define GPIO_OPA1_IN0P_PORT                                             (GPIOA)
#define GPIO_OPA1_IN0P_PIN                                     (DL_GPIO_PIN_18)
#define GPIO_OPA1_IN0P_IOMUX                                    (IOMUX_PINCM19)
#define GPIO_OPA1_IN0P_IOMUX_FUNCTION            (IOMUX_PINCM19_PF_UNCONNECTED)
...
/* UART for data logging communication */
...
/* GPIO for HDC2010 temperature and humidity sensor */
...
/* GPIO for enable, shut down, interrupt inputs */
#define TIA_EN_PORT                                                     (GPIOA)
#define TIA_EN_PIN                                             (DL_GPIO_PIN_25)
#define TIA_EN_IOMUX                                            (IOMUX_PINCM26)

#define LDO_5V_EN_PORT                                                  (GPIOA)
#define LDO_5V_EN_PIN                                          (DL_GPIO_PIN_15)
#define LDO_5V_EN_IOMUX                                         (IOMUX_PINCM16)

#define HDC_INT_PORT                                                    (GPIOA)
#define HDC_INT_PIN                                             (DL_GPIO_PIN_6)
#define HDC_INT_IOMUX                                            (IOMUX_PINCM7)
